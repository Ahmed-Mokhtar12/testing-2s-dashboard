...
import { LayoutDashboard, Star, MessageCircle, Mail, TrendingUp, Inbox, Share2, Send, Rocket } from 'lucide-react';
...
const items = [
  ...
  { title: 'Pre-publish', url: '/dashboard/pre-publish', icon: Rocket },
];
